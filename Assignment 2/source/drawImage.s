...
drawImage:
    ...
    push        {r4 - r9, fp, lr}                   // Pushes the specified registers to the stack to preserve them
    ...
    frameBufferData .req    r3                      // Creates an alias for the frame buffer data register
    offset      .req        r4                      // Creates an alias for the offset register
    imageWidth  .req        r5                      // Creates an alias for the input image width register
    imageHeight .req        r6                      // Creates an alias for the input image height register
    screenWidth .req        r7                      // Creates an alias for the display width register
    imageDataOffset .req    r8                      // Creates an alias for the image address location register
    counter     .req        r9                      // Creates an alias for the iteration counter register
    ...
    pop         {r4 - r9, fp, lr}                   // Pops the specified registers from the stack to preserve them
